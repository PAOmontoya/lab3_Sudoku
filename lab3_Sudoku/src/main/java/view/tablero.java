...
public class tablero extends JPanel{
    ...
    public void crearCamposTxt(){
        ...
        for(int i=0; i<listaTxt.length;i++){
            for(int j=0; j<listaTxt[0].length;j++){
                ...
                txt.setFont(new Font("Montserrat",Font.BOLD,txtTamanoLetra));
    ...
    public int getTxtTamanoLetra() {
        return txtTamanoLetra;
    }

    public void setTxtTamanoLetra(int txtTamanoLetra) {
        this.txtTamanoLetra = txtTamanoLetra;
    }
    ...
    public ArrayList<JTextField> getListaTxtGenerados() {
        return listaTxtGenerados;
    }

    public void setListaTxtGenerados(ArrayList<JTextField> listaTxtGenerados) {
        this.listaTxtGenerados = listaTxtGenerados;
    }
    ...
    public void setTxtSelected(JTextField txtSelected) {
